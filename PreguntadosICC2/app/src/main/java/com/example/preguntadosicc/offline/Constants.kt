...
object Constants {
    ...
    fun getQuestions() : ArrayList<Question>{
        ...
        val que15 = Question(15,"Computacion", "Luego de realizar al implementación de una tarea solicitada usted necesitara guardar el trabajo realizado cual de los siguientes comandos de GIT utilizaría?", "Pull", "Commit", "Merge","NA", 2)
